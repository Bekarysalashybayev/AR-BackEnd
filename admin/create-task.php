...
$solution=$_POST['sol'];
$answer=$_POST['answer'];	
$vimage=$_FILES["img"]["name"];
$vimage = "http://augmented.zzz.com.ua/admin/admin-ar/img/taskimg/" .$vimage;

move_uploaded_file($_FILES["img"]["tmp_name"],"img/taskimg/".$_FILES["img"]["name"]);

 $sql="INSERT INTO  Task(Task_number, task, Solution, Picture, Answer, Theory_id) 
                   VALUES(:number,:task,:solution,:vimage,:answer, :id)";
...
<head>
	...
	<title>Arr app | Admin Create Task</title>
                    ...
                    <div class="panel-body">
                      <form method="post" class="form-horizontal" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control" name="sol" rows="4" required></textarea>
                          </div>
                        </div>
                        <div class="form-group">
